...
import com.inlearning.app.student.adapter.HomeworkInfoAdapter;
import com.inlearning.app.common.util.StatusBar;

import java.util.ArrayList;
import java.util.List;

public class HomeworkListActivity extends AppCompatActivity implements View.OnClickListener{
    private RecyclerView mHomeworkInfoView;
    private HomeworkInfoAdapter mHomeworkInfoAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mHomeworkInfoView = findViewById(R.id.rv_common_view);
        mTitleView = findViewById(R.id.tv_title);
        mTitleView.setText("作业");
        mHomeworkInfoAdapter = new HomeworkInfoAdapter(mCourseList);
        mHomeworkInfoView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false));
        mHomeworkInfoView.setAdapter(mHomeworkInfoAdapter);
