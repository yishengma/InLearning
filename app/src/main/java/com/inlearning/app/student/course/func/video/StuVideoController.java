...
public class StuVideoController extends GestureVideoController implements View.OnClickListener {

    protected ImageView mLockButton;

    protected ProgressBar mLoadingProgress;

    private StuVodControlView mStuVodControlView;

    public StuVideoController(@NonNull Context context) {
        this(context, null);
    }

    public StuVideoController(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StuVideoController(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    public void addDefaultControlComponent(String title, boolean isLive) {
        ...
        if (isLive) {
            ...
            addControlComponent(mStuVodControlView = new StuVodControlView(getContext()));
        }
    ...
    public StuVodControlView getStuVodControlView() {
        return mStuVodControlView;
    }
}