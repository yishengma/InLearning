...
import com.inlearning.app.student.adapter.ExerciseInfoAdapter;
...
public class ExerciseActivity extends AppCompatActivity implements View.OnClickListener{
    private RecyclerView mExerciseInfoView;
    private ExerciseInfoAdapter mExerciseInfoAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mExerciseInfoView = findViewById(R.id.rv_common_view);
        mTitleView = findViewById(R.id.tv_title);
        mTitleView.setText("课中练习");
        mExerciseInfoAdapter = new ExerciseInfoAdapter(mCourseList);
        mExerciseInfoView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false));
        mExerciseInfoView.setAdapter(mExerciseInfoAdapter);
